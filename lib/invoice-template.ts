...
export function getInvoiceLines(invoice: Invoice): InvoiceLine[] {
  ...
  return [{
    ...
    vat_rate: invoice.subtotal > 0 ? Math.round((invoice.vat_total / invoice.subtotal) * 100) : 21,
